...
const handleSubmit = async () => {
    ...
    try {
      ...
      const serverUserId = responseUser?.id || responseUser?.user?.id || 1;
        ...
        <Card style={[styles.loginCard, { width: isDesktop ? 450 : '100%' }]}>
          <CardHeader style={styles.header}>
            ...
            <CardTitle>
              <Text style={styles.mainTitle}>
                Selamat Datang di <Text style={{ color: theme.colors.primary }}>Ricebowland</Text>
              </Text>
            </CardTitle>
          ...
          <CardContent style={styles.formContainer}>
            ...
            <View style={styles.divider}>
              ...
              <Text style={styles.dividerText}>Baru di Ricebowland?</Text>
              <View style={[styles.line, { backgroundColor: theme.colors.border }]} />
            </View>
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    backgroundColor: "#FEF9F5", // Background krem halus seperti Figma
    borderRadius: 12,
  },
  alignRight: {
    alignItems: "flex-end",
